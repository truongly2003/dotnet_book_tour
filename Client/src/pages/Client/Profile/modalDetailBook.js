        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            <div className="border-top pt-3">
              <h6>
                <a href={booking.tour_link} target="_blank" rel="noopener noreferrer">
                  {booking.tour_name}
                </a>
              </h6>
              <div className="row">
                <div className="col-6">
                  <p><strong>Mã tour:</strong> {booking.tour_code}</p>
                  <p><strong>Thời gian:</strong> {booking.duration}</p>
                  <p><strong>Ngày khởi hành:</strong> {booking.start_date}</p>
                </div>
                <div className="col-6">
                  <p><strong>Khởi hành từ:</strong> {booking.departure}</p>
            ...
            <div className="border-top pt-3">
              ...
              <table className="table table-bordered">
                ...
                <tfoot>
                  <tr>
                    <th colSpan="3" className="text-end">Tổng giá tour</th>
